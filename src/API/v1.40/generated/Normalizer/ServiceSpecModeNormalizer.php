...
class ServiceSpecModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecMode';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecMode';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_40\Model\ServiceSpecMode();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('Replicated', $data)) {
            $object->setReplicated($this->denormalizer->denormalize($data['Replicated'], 'Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecModeReplicated', 'json', $context));
            unset($data['Replicated']);
        }
        if (\array_key_exists('Global', $data)) {
            $object->setGlobal($this->denormalizer->denormalize($data['Global'], 'Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecModeGlobal', 'json', $context));
            unset($data['Global']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecMode' => false);
    }
}