...
class SwarmNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_40\\Model\\Swarm';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_40\\Model\\Swarm';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_40\Model\Swarm();
        ...
        if (\array_key_exists('Spec', $data)) {
            $object->setSpec($this->denormalizer->denormalize($data['Spec'], 'Mdshack\\Docker\\API\\v1_40\\Model\\SwarmSpec', 'json', $context));
            unset($data['Spec']);
        }
        ...
        if (\array_key_exists('JoinTokens', $data)) {
            $object->setJoinTokens($this->denormalizer->denormalize($data['JoinTokens'], 'Mdshack\\Docker\\API\\v1_40\\Model\\JoinTokens', 'json', $context));
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_40\\Model\\Swarm' => false];
    }
}
