...
class ServicesCreatePostBodyNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_40\\Model\\ServicesCreatePostBody';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_40\\Model\\ServicesCreatePostBody';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_40\Model\ServicesCreatePostBody();
        ...
        if (\array_key_exists('TaskTemplate', $data)) {
            $object->setTaskTemplate($this->denormalizer->denormalize($data['TaskTemplate'], 'Mdshack\\Docker\\API\\v1_40\\Model\\TaskSpec', 'json', $context));
            unset($data['TaskTemplate']);
        }
        if (\array_key_exists('Mode', $data)) {
            $object->setMode($this->denormalizer->denormalize($data['Mode'], 'Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecMode', 'json', $context));
            unset($data['Mode']);
        }
        if (\array_key_exists('UpdateConfig', $data)) {
            $object->setUpdateConfig($this->denormalizer->denormalize($data['UpdateConfig'], 'Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecUpdateConfig', 'json', $context));
            unset($data['UpdateConfig']);
        }
        if (\array_key_exists('RollbackConfig', $data)) {
            $object->setRollbackConfig($this->denormalizer->denormalize($data['RollbackConfig'], 'Mdshack\\Docker\\API\\v1_40\\Model\\ServiceSpecRollbackConfig', 'json', $context));
        ...
        if (\array_key_exists('EndpointSpec', $data)) {
            $object->setEndpointSpec($this->denormalizer->denormalize($data['EndpointSpec'], 'Mdshack\\Docker\\API\\v1_40\\Model\\EndpointSpec', 'json', $context));
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_40\\Model\\ServicesCreatePostBody' => false];
    }
}
