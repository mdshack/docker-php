...
class NodeSpecNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_40\\Model\\NodeSpec';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_40\\Model\\NodeSpec';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_40\Model\NodeSpec();
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_40\\Model\\NodeSpec' => false];
    }
}
