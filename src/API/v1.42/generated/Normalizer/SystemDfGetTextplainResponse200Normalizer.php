...
class SystemDfGetTextplainResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\SystemDfGetTextplainResponse200';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\SystemDfGetTextplainResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\SystemDfGetTextplainResponse200();
        ...
        if (\array_key_exists('Images', $data)) {
            ...
            foreach ($data['Images'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API\\v1_42\\Model\\ImageSummary', 'json', $context);
            }
        ...
        if (\array_key_exists('Containers', $data)) {
            ...
            foreach ($data['Containers'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Mdshack\\Docker\\API\\v1_42\\Model\\ContainerSummary', 'json', $context);
            }
        ...
        if (\array_key_exists('Volumes', $data)) {
            ...
            foreach ($data['Volumes'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Mdshack\\Docker\\API\\v1_42\\Model\\Volume', 'json', $context);
            }
        ...
        if (\array_key_exists('BuildCache', $data)) {
            ...
            foreach ($data['BuildCache'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Mdshack\\Docker\\API\\v1_42\\Model\\BuildCache', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_42\\Model\\SystemDfGetTextplainResponse200' => false);
    }
}