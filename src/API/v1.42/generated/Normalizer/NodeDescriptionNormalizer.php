...
class NodeDescriptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\NodeDescription';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\NodeDescription';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\NodeDescription();
        ...
        if (\array_key_exists('Platform', $data)) {
            $object->setPlatform($this->denormalizer->denormalize($data['Platform'], 'Mdshack\\Docker\\API\\v1_42\\Model\\Platform', 'json', $context));
            unset($data['Platform']);
        }
        if (\array_key_exists('Resources', $data)) {
            $object->setResources($this->denormalizer->denormalize($data['Resources'], 'Mdshack\\Docker\\API\\v1_42\\Model\\ResourceObject', 'json', $context));
            unset($data['Resources']);
        }
        if (\array_key_exists('Engine', $data)) {
            $object->setEngine($this->denormalizer->denormalize($data['Engine'], 'Mdshack\\Docker\\API\\v1_42\\Model\\EngineDescription', 'json', $context));
            unset($data['Engine']);
        }
        if (\array_key_exists('TLSInfo', $data)) {
            $object->setTLSInfo($this->denormalizer->denormalize($data['TLSInfo'], 'Mdshack\\Docker\\API\\v1_42\\Model\\TLSInfo', 'json', $context));
            unset($data['TLSInfo']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_42\\Model\\NodeDescription' => false);
    }
}