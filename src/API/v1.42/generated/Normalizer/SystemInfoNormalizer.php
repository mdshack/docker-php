...
class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\SystemInfo';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\SystemInfo';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\SystemInfo();
        ...
        if (\array_key_exists('Plugins', $data)) {
            $object->setPlugins($this->denormalizer->denormalize($data['Plugins'], 'Mdshack\\Docker\\API\\v1_42\\Model\\PluginsInfo', 'json', $context));
            unset($data['Plugins']);
        }
        ...
        if (\array_key_exists('RegistryConfig', $data) && $data['RegistryConfig'] !== null) {
            $object->setRegistryConfig($this->denormalizer->denormalize($data['RegistryConfig'], 'Mdshack\\Docker\\API\\v1_42\\Model\\RegistryServiceConfig', 'json', $context));
        ...
        if (\array_key_exists('GenericResources', $data)) {
            ...
            foreach ($data['GenericResources'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Mdshack\\Docker\\API\\v1_42\\Model\\GenericResourcesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Runtimes', $data)) {
            ...
            foreach ($data['Runtimes'] as $key => $value_4) {
                $values_4[$key] = $this->denormalizer->denormalize($value_4, 'Mdshack\\Docker\\API\\v1_42\\Model\\Runtime', 'json', $context);
            }
        ...
        if (\array_key_exists('Swarm', $data)) {
            $object->setSwarm($this->denormalizer->denormalize($data['Swarm'], 'Mdshack\\Docker\\API\\v1_42\\Model\\SwarmInfo', 'json', $context));
            unset($data['Swarm']);
        }
        ...
        if (\array_key_exists('ContainerdCommit', $data)) {
            $object->setContainerdCommit($this->denormalizer->denormalize($data['ContainerdCommit'], 'Mdshack\\Docker\\API\\v1_42\\Model\\Commit', 'json', $context));
            unset($data['ContainerdCommit']);
        }
        if (\array_key_exists('RuncCommit', $data)) {
            $object->setRuncCommit($this->denormalizer->denormalize($data['RuncCommit'], 'Mdshack\\Docker\\API\\v1_42\\Model\\Commit', 'json', $context));
            unset($data['RuncCommit']);
        }
        if (\array_key_exists('InitCommit', $data)) {
            $object->setInitCommit($this->denormalizer->denormalize($data['InitCommit'], 'Mdshack\\Docker\\API\\v1_42\\Model\\Commit', 'json', $context));
        ...
        if (\array_key_exists('DefaultAddressPools', $data)) {
            ...
            foreach ($data['DefaultAddressPools'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Mdshack\\Docker\\API\\v1_42\\Model\\SystemInfoDefaultAddressPoolsItem', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_42\\Model\\SystemInfo' => false);
    }
}