...
class EngineDescriptionNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\EngineDescription';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\EngineDescription';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\EngineDescription();
        ...
        if (\array_key_exists('Plugins', $data)) {
            ...
            foreach ($data['Plugins'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Mdshack\\Docker\\API\\v1_42\\Model\\EngineDescriptionPluginsItem', 'json', $context);
            }
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_42\\Model\\EngineDescription' => false];
    }
}
