...
class ImagesSearchGetResponse200ItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\ImagesSearchGetResponse200Item';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\ImagesSearchGetResponse200Item';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\ImagesSearchGetResponse200Item();
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_42\\Model\\ImagesSearchGetResponse200Item' => false];
    }
}
