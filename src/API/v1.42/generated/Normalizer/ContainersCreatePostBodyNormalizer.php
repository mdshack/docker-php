...
class ContainersCreatePostBodyNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\ContainersCreatePostBody';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\ContainersCreatePostBody';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\ContainersCreatePostBody();
        ...
        if (\array_key_exists('NetworkingConfig', $data)) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data['NetworkingConfig'], 'Mdshack\\Docker\\API\\v1_42\\Model\\NetworkingConfig', 'json', $context));
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_42\\Model\\ContainersCreatePostBody' => false];
    }
}
