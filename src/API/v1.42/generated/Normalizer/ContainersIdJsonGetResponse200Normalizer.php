...
class ContainersIdJsonGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\ContainersIdJsonGetResponse200';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\ContainersIdJsonGetResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\ContainersIdJsonGetResponse200();
        ...
        if (\array_key_exists('State', $data) && $data['State'] !== null) {
            $object->setState($this->denormalizer->denormalize($data['State'], 'Mdshack\\Docker\\API\\v1_42\\Model\\ContainerState', 'json', $context));
            unset($data['State']);
        }
        ...
        if (\array_key_exists('HostConfig', $data)) {
            $object->setHostConfig($this->denormalizer->denormalize($data['HostConfig'], 'Mdshack\\Docker\\API\\v1_42\\Model\\HostConfig', 'json', $context));
            unset($data['HostConfig']);
        }
        if (\array_key_exists('GraphDriver', $data)) {
            $object->setGraphDriver($this->denormalizer->denormalize($data['GraphDriver'], 'Mdshack\\Docker\\API\\v1_42\\Model\\GraphDriverData', 'json', $context));
        ...
        if (\array_key_exists('Mounts', $data)) {
            ...
            foreach ($data['Mounts'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Mdshack\\Docker\\API\\v1_42\\Model\\MountPoint', 'json', $context);
            }
            $object->setMounts($values_2);
            unset($data['Mounts']);
        }
        if (\array_key_exists('Config', $data)) {
            $object->setConfig($this->denormalizer->denormalize($data['Config'], 'Mdshack\\Docker\\API\\v1_42\\Model\\ContainerConfig', 'json', $context));
            unset($data['Config']);
        }
        if (\array_key_exists('NetworkSettings', $data)) {
            $object->setNetworkSettings($this->denormalizer->denormalize($data['NetworkSettings'], 'Mdshack\\Docker\\API\\v1_42\\Model\\NetworkSettings', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_42\\Model\\ContainersIdJsonGetResponse200' => false);
    }
}