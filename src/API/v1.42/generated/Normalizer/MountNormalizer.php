...
class MountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_42\\Model\\Mount';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_42\\Model\\Mount';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_42\Model\Mount();
        ...
        if (\array_key_exists('BindOptions', $data)) {
            $object->setBindOptions($this->denormalizer->denormalize($data['BindOptions'], 'Mdshack\\Docker\\API\\v1_42\\Model\\MountBindOptions', 'json', $context));
            unset($data['BindOptions']);
        }
        if (\array_key_exists('VolumeOptions', $data)) {
            $object->setVolumeOptions($this->denormalizer->denormalize($data['VolumeOptions'], 'Mdshack\\Docker\\API\\v1_42\\Model\\MountVolumeOptions', 'json', $context));
            unset($data['VolumeOptions']);
        }
        if (\array_key_exists('TmpfsOptions', $data)) {
            $object->setTmpfsOptions($this->denormalizer->denormalize($data['TmpfsOptions'], 'Mdshack\\Docker\\API\\v1_42\\Model\\MountTmpfsOptions', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_42\\Model\\Mount' => false);
    }
}