...
class ServicesCreatePostBodyNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_43\\Model\\ServicesCreatePostBody';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_43\\Model\\ServicesCreatePostBody';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_43\Model\ServicesCreatePostBody();
        ...
        if (\array_key_exists('TaskTemplate', $data)) {
            $object->setTaskTemplate($this->denormalizer->denormalize($data['TaskTemplate'], 'Mdshack\\Docker\\API\\v1_43\\Model\\TaskSpec', 'json', $context));
            unset($data['TaskTemplate']);
        }
        if (\array_key_exists('Mode', $data)) {
            $object->setMode($this->denormalizer->denormalize($data['Mode'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceSpecMode', 'json', $context));
            unset($data['Mode']);
        }
        if (\array_key_exists('UpdateConfig', $data)) {
            $object->setUpdateConfig($this->denormalizer->denormalize($data['UpdateConfig'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceSpecUpdateConfig', 'json', $context));
            unset($data['UpdateConfig']);
        }
        if (\array_key_exists('RollbackConfig', $data)) {
            $object->setRollbackConfig($this->denormalizer->denormalize($data['RollbackConfig'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceSpecRollbackConfig', 'json', $context));
            unset($data['RollbackConfig']);
        }
        if (\array_key_exists('Networks', $data)) {
            $values_1 = [];
            foreach ($data['Networks'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Mdshack\\Docker\\API\\v1_43\\Model\\NetworkAttachmentConfig', 'json', $context);
            }
            $object->setNetworks($values_1);
            unset($data['Networks']);
        }
        if (\array_key_exists('EndpointSpec', $data)) {
            $object->setEndpointSpec($this->denormalizer->denormalize($data['EndpointSpec'], 'Mdshack\\Docker\\API\\v1_43\\Model\\EndpointSpec', 'json', $context));
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_43\\Model\\ServicesCreatePostBody' => false];
    }
}
