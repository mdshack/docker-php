...
class BuildInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\BuildInfo';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\BuildInfo';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API${NAMESPACE}\Model\BuildInfo();
        ...
        if (\array_key_exists('errorDetail', $data)) {
            $object->setErrorDetail($this->denormalizer->denormalize($data['errorDetail'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ErrorDetail', 'json', $context));
        ...
        if (\array_key_exists('progressDetail', $data)) {
            $object->setProgressDetail($this->denormalizer->denormalize($data['progressDetail'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ProgressDetail', 'json', $context));
            unset($data['progressDetail']);
        }
        if (\array_key_exists('aux', $data)) {
            $object->setAux($this->denormalizer->denormalize($data['aux'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ImageID', 'json', $context));
            unset($data['aux']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API${NAMESPACE}\\Model\\BuildInfo' => false);
    }
}