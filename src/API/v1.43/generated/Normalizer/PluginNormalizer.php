...
class PluginNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\Plugin';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\Plugin';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\Plugin();
        ...
        if (\array_key_exists('Settings', $data)) {
            $object->setSettings($this->denormalizer->denormalize($data['Settings'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginSettings', 'json', $context));
            unset($data['Settings']);
        }
        ...
        if (\array_key_exists('Config', $data)) {
            $object->setConfig($this->denormalizer->denormalize($data['Config'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfig', 'json', $context));
            unset($data['Config']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\Plugin' => false);
    }
}