...
class PluginConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfig';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfig';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\PluginConfig();
        ...
        if (\array_key_exists('Interface', $data)) {
            $object->setInterface($this->denormalizer->denormalize($data['Interface'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfigInterface', 'json', $context));
        ...
        if (\array_key_exists('User', $data)) {
            $object->setUser($this->denormalizer->denormalize($data['User'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfigUser', 'json', $context));
            unset($data['User']);
        }
        if (\array_key_exists('Network', $data)) {
            $object->setNetwork($this->denormalizer->denormalize($data['Network'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfigNetwork', 'json', $context));
            unset($data['Network']);
        }
        if (\array_key_exists('Linux', $data)) {
            $object->setLinux($this->denormalizer->denormalize($data['Linux'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfigLinux', 'json', $context));
            unset($data['Linux']);
        }
        ...
        if (\array_key_exists('Mounts', $data)) {
            ...
            foreach ($data['Mounts'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Mdshack\\Docker\\API\\_____\\Model\\PluginMount', 'json', $context);
            }
        ...
        if (\array_key_exists('Env', $data)) {
            ...
            foreach ($data['Env'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Mdshack\\Docker\\API\\_____\\Model\\PluginEnv', 'json', $context);
            }
            $object->setEnv($values_2);
            unset($data['Env']);
        }
        if (\array_key_exists('Args', $data)) {
            $object->setArgs($this->denormalizer->denormalize($data['Args'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfigArgs', 'json', $context));
            unset($data['Args']);
        }
        if (\array_key_exists('rootfs', $data)) {
            $object->setRootfs($this->denormalizer->denormalize($data['rootfs'], 'Mdshack\\Docker\\API\\_____\\Model\\PluginConfigRootfs', 'json', $context));
            unset($data['rootfs']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\PluginConfig' => false);
    }
}