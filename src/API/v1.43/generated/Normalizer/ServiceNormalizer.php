...
class ServiceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_43\\Model\\Service';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_43\\Model\\Service';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_43\Model\Service();
        ...
        if (\array_key_exists('Spec', $data)) {
            $object->setSpec($this->denormalizer->denormalize($data['Spec'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceSpec', 'json', $context));
            unset($data['Spec']);
        }
        if (\array_key_exists('Endpoint', $data)) {
            $object->setEndpoint($this->denormalizer->denormalize($data['Endpoint'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceEndpoint', 'json', $context));
            unset($data['Endpoint']);
        }
        if (\array_key_exists('UpdateStatus', $data)) {
            $object->setUpdateStatus($this->denormalizer->denormalize($data['UpdateStatus'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceUpdateStatus', 'json', $context));
            unset($data['UpdateStatus']);
        }
        if (\array_key_exists('ServiceStatus', $data)) {
            $object->setServiceStatus($this->denormalizer->denormalize($data['ServiceStatus'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceServiceStatus', 'json', $context));
            unset($data['ServiceStatus']);
        }
        if (\array_key_exists('JobStatus', $data)) {
            $object->setJobStatus($this->denormalizer->denormalize($data['JobStatus'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ServiceJobStatus', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_43\\Model\\Service' => false);
    }
}