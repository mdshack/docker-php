...
class NetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\NetworkSettings';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\NetworkSettings';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API${NAMESPACE}\Model\NetworkSettings();
        ...
        if (\array_key_exists('Ports', $data)) {
            ...
            foreach ($data['Ports'] as $key => $value) {
                ...
                foreach ($value as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\PortBinding', 'json', $context);
                }
                $values[$key] = $values_1;
            }
        ...
        if (\array_key_exists('SecondaryIPAddresses', $data) && $data['SecondaryIPAddresses'] !== null) {
            ...
            foreach ($data['SecondaryIPAddresses'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('SecondaryIPv6Addresses', $data) && $data['SecondaryIPv6Addresses'] !== null) {
            ...
            foreach ($data['SecondaryIPv6Addresses'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('Networks', $data)) {
            ...
            foreach ($data['Networks'] as $key_1 => $value_4) {
                $values_4[$key_1] = $this->denormalizer->denormalize($value_4, 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\EndpointSettings', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API${NAMESPACE}\\Model\\NetworkSettings' => false);
    }
}