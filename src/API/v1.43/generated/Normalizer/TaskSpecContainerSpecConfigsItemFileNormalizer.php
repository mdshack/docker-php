...
class TaskSpecContainerSpecConfigsItemFileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\TaskSpecContainerSpecConfigsItemFile';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\TaskSpecContainerSpecConfigsItemFile';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\TaskSpecContainerSpecConfigsItemFile();
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\TaskSpecContainerSpecConfigsItemFile' => false);
    }
}