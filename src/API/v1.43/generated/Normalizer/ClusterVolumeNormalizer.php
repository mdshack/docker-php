...
class ClusterVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ClusterVolume';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ClusterVolume';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API$NAMESPACE\Model\ClusterVolume();
        ...
        if (\array_key_exists('Spec', $data)) {
            $object->setSpec($this->denormalizer->denormalize($data['Spec'], 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ClusterVolumeSpec', 'json', $context));
            unset($data['Spec']);
        }
        if (\array_key_exists('Info', $data)) {
            $object->setInfo($this->denormalizer->denormalize($data['Info'], 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ClusterVolumeInfo', 'json', $context));
            unset($data['Info']);
        }
        if (\array_key_exists('PublishStatus', $data)) {
            $values = array();
            foreach ($data['PublishStatus'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ClusterVolumePublishStatusItem', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API$NAMESPACE\\Model\\ClusterVolume' => false);
    }
}