...
class TaskSpecContainerSpecUlimitsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\TaskSpecContainerSpecUlimitsItem';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\TaskSpecContainerSpecUlimitsItem';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\TaskSpecContainerSpecUlimitsItem();
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\TaskSpecContainerSpecUlimitsItem' => false);
    }
}