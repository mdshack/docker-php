...
class ClusterVolumeSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ClusterVolumeSpec';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ClusterVolumeSpec';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API${NAMESPACE}\Model\ClusterVolumeSpec();
        ...
        if (\array_key_exists('AccessMode', $data)) {
            $object->setAccessMode($this->denormalizer->denormalize($data['AccessMode'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ClusterVolumeSpecAccessMode', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API${NAMESPACE}\\Model\\ClusterVolumeSpec' => false);
    }
}