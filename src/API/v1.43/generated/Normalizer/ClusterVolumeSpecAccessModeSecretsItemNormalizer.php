...
class ClusterVolumeSpecAccessModeSecretsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ClusterVolumeSpecAccessModeSecretsItem';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ClusterVolumeSpecAccessModeSecretsItem';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API${NAMESPACE}\Model\ClusterVolumeSpecAccessModeSecretsItem();
    ...
    {
        return array('Mdshack\\Docker\\API${NAMESPACE}\\Model\\ClusterVolumeSpecAccessModeSecretsItem' => false);
    }
}