...
class NetworksIdConnectPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\NetworksIdConnectPostBody';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\NetworksIdConnectPostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\NetworksIdConnectPostBody();
        ...
        if (\array_key_exists('EndpointConfig', $data)) {
            $object->setEndpointConfig($this->denormalizer->denormalize($data['EndpointConfig'], 'Mdshack\\Docker\\API\\_____\\Model\\EndpointSettings', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\NetworksIdConnectPostBody' => false);
    }
}