...
class SystemVersionComponentsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\SystemVersionComponentsItem';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\SystemVersionComponentsItem';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\SystemVersionComponentsItem();
        ...
        if (\array_key_exists('Details', $data) && $data['Details'] !== null) {
            $object->setDetails($this->denormalizer->denormalize($data['Details'], 'Mdshack\\Docker\\API\\_____\\Model\\SystemVersionComponentsItemDetails', 'json', $context));
            unset($data['Details']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\SystemVersionComponentsItem' => false);
    }
}