...
class SecretsCreatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\SecretsCreatePostBody';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\SecretsCreatePostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\SecretsCreatePostBody();
        ...
        if (\array_key_exists('Driver', $data)) {
            $object->setDriver($this->denormalizer->denormalize($data['Driver'], 'Mdshack\\Docker\\API\\_____\\Model\\Driver', 'json', $context));
            unset($data['Driver']);
        }
        if (\array_key_exists('Templating', $data)) {
            $object->setTemplating($this->denormalizer->denormalize($data['Templating'], 'Mdshack\\Docker\\API\\_____\\Model\\Driver', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\SecretsCreatePostBody' => false);
    }
}