...
class ContainerSummaryNetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainerSummaryNetworkSettings';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainerSummaryNetworkSettings';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API$NAMESPACE\Model\ContainerSummaryNetworkSettings();
        ...
        if (\array_key_exists('Networks', $data)) {
            ...
            foreach ($data['Networks'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API$NAMESPACE\\Model\\EndpointSettings', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainerSummaryNetworkSettings' => false);
    }
}