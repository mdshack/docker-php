...
class VolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\Volume';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\Volume';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\Volume();
        ...
        if (\array_key_exists('Status', $data)) {
            ...
            foreach ($data['Status'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API\\_____\\Model\\VolumeStatusItem', 'json', $context);
            }
        ...
        if (\array_key_exists('ClusterVolume', $data)) {
            $object->setClusterVolume($this->denormalizer->denormalize($data['ClusterVolume'], 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolume', 'json', $context));
        ...
        if (\array_key_exists('UsageData', $data) && $data['UsageData'] !== null) {
            $object->setUsageData($this->denormalizer->denormalize($data['UsageData'], 'Mdshack\\Docker\\API\\_____\\Model\\VolumeUsageData', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\Volume' => false);
    }
}