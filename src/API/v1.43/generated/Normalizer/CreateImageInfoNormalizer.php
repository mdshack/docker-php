...
class CreateImageInfoNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_43\\Model\\CreateImageInfo';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_43\\Model\\CreateImageInfo';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_43\Model\CreateImageInfo();
        ...
        if (\array_key_exists('errorDetail', $data)) {
            $object->setErrorDetail($this->denormalizer->denormalize($data['errorDetail'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ErrorDetail', 'json', $context));
        ...
        if (\array_key_exists('progressDetail', $data)) {
            $object->setProgressDetail($this->denormalizer->denormalize($data['progressDetail'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ProgressDetail', 'json', $context));
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_43\\Model\\CreateImageInfo' => false];
    }
}
