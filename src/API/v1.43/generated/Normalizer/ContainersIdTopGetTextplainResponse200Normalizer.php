...
class ContainersIdTopGetTextplainResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\ContainersIdTopGetTextplainResponse200';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\ContainersIdTopGetTextplainResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\ContainersIdTopGetTextplainResponse200();
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\ContainersIdTopGetTextplainResponse200' => false);
    }
}