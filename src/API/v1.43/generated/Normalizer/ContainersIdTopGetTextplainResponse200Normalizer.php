...
class ContainersIdTopGetTextplainResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_43\\Model\\ContainersIdTopGetTextplainResponse200';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_43\\Model\\ContainersIdTopGetTextplainResponse200';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_43\Model\ContainersIdTopGetTextplainResponse200();
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_43\\Model\\ContainersIdTopGetTextplainResponse200' => false];
    }
}
