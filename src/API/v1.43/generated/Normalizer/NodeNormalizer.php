...
class NodeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\Node';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\Node';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API${NAMESPACE}\Model\Node();
        ...
        if (\array_key_exists('Spec', $data)) {
            $object->setSpec($this->denormalizer->denormalize($data['Spec'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\NodeSpec', 'json', $context));
            unset($data['Spec']);
        }
        if (\array_key_exists('Description', $data)) {
            $object->setDescription($this->denormalizer->denormalize($data['Description'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\NodeDescription', 'json', $context));
            unset($data['Description']);
        }
        if (\array_key_exists('Status', $data)) {
            $object->setStatus($this->denormalizer->denormalize($data['Status'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\NodeStatus', 'json', $context));
            unset($data['Status']);
        }
        if (\array_key_exists('ManagerStatus', $data) && $data['ManagerStatus'] !== null) {
            $object->setManagerStatus($this->denormalizer->denormalize($data['ManagerStatus'], 'Mdshack\\Docker\\API${NAMESPACE}\\Model\\ManagerStatus', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API${NAMESPACE}\\Model\\Node' => false);
    }
}