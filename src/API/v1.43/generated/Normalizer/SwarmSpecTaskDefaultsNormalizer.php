...
class SwarmSpecTaskDefaultsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\SwarmSpecTaskDefaults';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\SwarmSpecTaskDefaults';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\SwarmSpecTaskDefaults();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('LogDriver', $data)) {
            $object->setLogDriver($this->denormalizer->denormalize($data['LogDriver'], 'Mdshack\\Docker\\API\\_____\\Model\\SwarmSpecTaskDefaultsLogDriver', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\SwarmSpecTaskDefaults' => false);
    }
}