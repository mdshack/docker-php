...
class ContainersCreatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainersCreatePostBody';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainersCreatePostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API$NAMESPACE\Model\ContainersCreatePostBody();
        ...
        if (\array_key_exists('ExposedPorts', $data) && $data['ExposedPorts'] !== null) {
            ...
            foreach ($data['ExposedPorts'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainerConfigExposedPortsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Volumes', $data)) {
            ...
            foreach ($data['Volumes'] as $key_1 => $value_3) {
                $values_3[$key_1] = $this->denormalizer->denormalize($value_3, 'Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainerConfigVolumesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('HostConfig', $data)) {
            $object->setHostConfig($this->denormalizer->denormalize($data['HostConfig'], 'Mdshack\\Docker\\API$NAMESPACE\\Model\\HostConfig', 'json', $context));
            unset($data['HostConfig']);
        }
        if (\array_key_exists('NetworkingConfig', $data)) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data['NetworkingConfig'], 'Mdshack\\Docker\\API$NAMESPACE\\Model\\NetworkingConfig', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API$NAMESPACE\\Model\\ContainersCreatePostBody' => false);
    }
}