...
class ContainersCreatePostBodyNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_43\\Model\\ContainersCreatePostBody';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_43\\Model\\ContainersCreatePostBody';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_43\Model\ContainersCreatePostBody();
        ...
        if (\array_key_exists('ExposedPorts', $data) && $data['ExposedPorts'] !== null) {
            ...
            foreach ($data['ExposedPorts'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API\\v1_43\\Model\\ContainerConfigExposedPortsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Volumes', $data)) {
            ...
            foreach ($data['Volumes'] as $key_1 => $value_3) {
                $values_3[$key_1] = $this->denormalizer->denormalize($value_3, 'Mdshack\\Docker\\API\\v1_43\\Model\\ContainerConfigVolumesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('NetworkingConfig', $data)) {
            $object->setNetworkingConfig($this->denormalizer->denormalize($data['NetworkingConfig'], 'Mdshack\\Docker\\API\\v1_43\\Model\\NetworkingConfig', 'json', $context));
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_43\\Model\\ContainersCreatePostBody' => false];
    }
}
