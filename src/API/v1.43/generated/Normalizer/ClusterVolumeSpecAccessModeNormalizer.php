...
class ClusterVolumeSpecAccessModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpecAccessMode';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpecAccessMode';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\ClusterVolumeSpecAccessMode();
        ...
        if (\array_key_exists('MountVolume', $data)) {
            $object->setMountVolume($this->denormalizer->denormalize($data['MountVolume'], 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpecAccessModeMountVolume', 'json', $context));
            unset($data['MountVolume']);
        }
        if (\array_key_exists('Secrets', $data)) {
            $values = array();
            foreach ($data['Secrets'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpecAccessModeSecretsItem', 'json', $context);
            }
            $object->setSecrets($values);
            unset($data['Secrets']);
        }
        if (\array_key_exists('AccessibilityRequirements', $data)) {
            $object->setAccessibilityRequirements($this->denormalizer->denormalize($data['AccessibilityRequirements'], 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpecAccessModeAccessibilityRequirements', 'json', $context));
            unset($data['AccessibilityRequirements']);
        }
        if (\array_key_exists('CapacityRange', $data)) {
            $object->setCapacityRange($this->denormalizer->denormalize($data['CapacityRange'], 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpecAccessModeCapacityRange', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpecAccessMode' => false);
    }
}