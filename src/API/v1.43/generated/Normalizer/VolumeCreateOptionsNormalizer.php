...
class VolumeCreateOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_43\\Model\\VolumeCreateOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_43\\Model\\VolumeCreateOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_43\Model\VolumeCreateOptions();
        ...
        if (\array_key_exists('ClusterVolumeSpec', $data)) {
            $object->setClusterVolumeSpec($this->denormalizer->denormalize($data['ClusterVolumeSpec'], 'Mdshack\\Docker\\API\\v1_43\\Model\\ClusterVolumeSpec', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_43\\Model\\VolumeCreateOptions' => false);
    }
}