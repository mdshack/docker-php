...
class VolumeCreateOptionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\_____\\Model\\VolumeCreateOptions';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\_____\\Model\\VolumeCreateOptions';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\_____\Model\VolumeCreateOptions();
        ...
        if (\array_key_exists('ClusterVolumeSpec', $data)) {
            $object->setClusterVolumeSpec($this->denormalizer->denormalize($data['ClusterVolumeSpec'], 'Mdshack\\Docker\\API\\_____\\Model\\ClusterVolumeSpec', 'json', $context));
    ...
    {
        return array('Mdshack\\Docker\\API\\_____\\Model\\VolumeCreateOptions' => false);
    }
}