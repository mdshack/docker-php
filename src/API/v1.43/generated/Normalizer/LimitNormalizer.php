...
class LimitNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_43\\Model\\Limit';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_43\\Model\\Limit';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_43\Model\Limit();
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->isInitialized('pids') && $object->getPids() !== null) {
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_43\\Model\\Limit' => false];
    }
}
