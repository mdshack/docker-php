...
class ExecStart extends \Mdshack\Docker\API\_____\Runtime\Client\BaseEndpoint implements \Mdshack\Docker\API\_____\Runtime\Client\Endpoint
{
    protected $id;
    protected $accept;
    /**
    ...
    */
    public function __construct(string $id, ?\Mdshack\Docker\API\_____\Model\ExecIdStartPostBody $requestBody = null, array $accept = array())
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \Mdshack\Docker\API\_____\Model\ExecIdStartPostBody) {
