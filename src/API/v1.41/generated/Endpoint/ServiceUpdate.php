...
class ServiceUpdate extends \Mdshack\Docker\API\v1_41\Runtime\Client\BaseEndpoint implements \Mdshack\Docker\API\v1_41\Runtime\Client\Endpoint
{
    ...
    * }
    */
    public function __construct(string $id, \Mdshack\Docker\API\v1_41\Model\ServicesIdUpdatePostBody $requestBody, array $queryParameters = array(), array $headerParameters = array())
    {
        $this->id = $id;
