...
class PluginNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_41\\Model\\Plugin';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_41\\Model\\Plugin';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_41\Model\Plugin();
        ...
        if (\array_key_exists('Settings', $data)) {
            $object->setSettings($this->denormalizer->denormalize($data['Settings'], 'Mdshack\\Docker\\API\\v1_41\\Model\\PluginSettings', 'json', $context));
            unset($data['Settings']);
        }
        ...
        if (\array_key_exists('Config', $data)) {
            $object->setConfig($this->denormalizer->denormalize($data['Config'], 'Mdshack\\Docker\\API\\v1_41\\Model\\PluginConfig', 'json', $context));
            unset($data['Config']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_41\\Model\\Plugin' => false);
    }
}