...
class RegistryServiceConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_41\\Model\\RegistryServiceConfig';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_41\\Model\\RegistryServiceConfig';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_41\Model\RegistryServiceConfig();
        ...
        if (\array_key_exists('IndexConfigs', $data)) {
            ...
            foreach ($data['IndexConfigs'] as $key => $value_3) {
                $values_3[$key] = $this->denormalizer->denormalize($value_3, 'Mdshack\\Docker\\API\\v1_41\\Model\\IndexInfo', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_41\\Model\\RegistryServiceConfig' => false);
    }
}