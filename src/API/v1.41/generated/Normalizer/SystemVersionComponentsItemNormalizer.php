...
class SystemVersionComponentsItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_41\\Model\\SystemVersionComponentsItem';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_41\\Model\\SystemVersionComponentsItem';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_41\Model\SystemVersionComponentsItem();
        ...
        if (\array_key_exists('Details', $data) && $data['Details'] !== null) {
            $object->setDetails($this->denormalizer->denormalize($data['Details'], 'Mdshack\\Docker\\API\\v1_41\\Model\\SystemVersionComponentsItemDetails', 'json', $context));
            unset($data['Details']);
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_41\\Model\\SystemVersionComponentsItem' => false];
    }
}
