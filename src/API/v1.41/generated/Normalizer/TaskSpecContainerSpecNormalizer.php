...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpec';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpec';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_41\Model\TaskSpecContainerSpec();
        ...
        if (\array_key_exists('Privileges', $data)) {
            $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], 'Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
        ...
        if (\array_key_exists('Mounts', $data)) {
            ...
            foreach ($data['Mounts'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Mdshack\\Docker\\API\\v1_41\\Model\\Mount', 'json', $context);
            }
        ...
        if (\array_key_exists('DNSConfig', $data)) {
            $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], 'Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
            unset($data['DNSConfig']);
        }
        if (\array_key_exists('Secrets', $data)) {
            $values_7 = array();
            foreach ($data['Secrets'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Configs', $data)) {
            ...
            foreach ($data['Configs'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Ulimits', $data)) {
            ...
            foreach ($data['Ulimits'] as $value_12) {
                $values_12[] = $this->denormalizer->denormalize($value_12, 'Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpecUlimitsItem', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_41\\Model\\TaskSpecContainerSpec' => false);
    }
}