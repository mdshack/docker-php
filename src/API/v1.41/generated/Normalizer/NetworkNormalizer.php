...
class NetworkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_41\\Model\\Network';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_41\\Model\\Network';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_41\Model\Network();
        ...
        if (\array_key_exists('IPAM', $data)) {
            $object->setIPAM($this->denormalizer->denormalize($data['IPAM'], 'Mdshack\\Docker\\API\\v1_41\\Model\\IPAM', 'json', $context));
            unset($data['IPAM']);
        }
        ...
        if (\array_key_exists('Containers', $data)) {
            ...
            foreach ($data['Containers'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API\\v1_41\\Model\\NetworkContainer', 'json', $context);
            }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_41\\Model\\Network' => false);
    }
}