...
class ResourceObjectNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_41\\Model\\ResourceObject';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_41\\Model\\ResourceObject';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Mdshack\Docker\API\v1_41\Model\ResourceObject();
        ...
        if (\array_key_exists('GenericResources', $data)) {
            ...
            foreach ($data['GenericResources'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Mdshack\\Docker\\API\\v1_41\\Model\\GenericResourcesItem', 'json', $context);
            }
    ...
    {
        return ['Mdshack\\Docker\\API\\v1_41\\Model\\ResourceObject' => false];
    }
}
