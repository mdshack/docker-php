...
class ImageInspectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Mdshack\\Docker\\API\\v1_41\\Model\\ImageInspect';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Mdshack\\Docker\\API\\v1_41\\Model\\ImageInspect';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Mdshack\Docker\API\v1_41\Model\ImageInspect();
        ...
        if (\array_key_exists('ContainerConfig', $data)) {
            $object->setContainerConfig($this->denormalizer->denormalize($data['ContainerConfig'], 'Mdshack\\Docker\\API\\v1_41\\Model\\ContainerConfig', 'json', $context));
        ...
        if (\array_key_exists('RootFS', $data)) {
            $object->setRootFS($this->denormalizer->denormalize($data['RootFS'], 'Mdshack\\Docker\\API\\v1_41\\Model\\ImageInspectRootFS', 'json', $context));
            unset($data['RootFS']);
        }
        if (\array_key_exists('Metadata', $data)) {
            $object->setMetadata($this->denormalizer->denormalize($data['Metadata'], 'Mdshack\\Docker\\API\\v1_41\\Model\\ImageInspectMetadata', 'json', $context));
            unset($data['Metadata']);
        }
    ...
    {
        return array('Mdshack\\Docker\\API\\v1_41\\Model\\ImageInspect' => false);
    }
}